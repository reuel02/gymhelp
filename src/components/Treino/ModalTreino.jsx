                        ...
                        {exercicios.map((exercicio, i) => (
                            <div key={i} className="mb-3 bg-[#1A1A1A] border border-[#252525] rounded-xl p-3 sm:bg-transparent sm:border-0 sm:rounded-none sm:p-0 sm:mb-2">
                                ...
                                <div className="hidden sm:flex items-center gap-2">
                                    ...
                                    />
                                    <input className="bg-[#181818] border border-[#2A2A2A] rounded-lg py-2 px-2.5 text-[13px] text-[#E0E0E0] outline-none transition-colors duration-150 font-sans min-w-0 flex-1 focus:border-[#E8881A]" type="number" placeholder="4" min="1"
                                        onChange={(e) => { const n = [...exercicios]; n[i].series = e.target.value; setExercicios(n); }} />
                                    <input className="bg-[#181818] border border-[#2A2A2A] rounded-lg py-2 px-2.5 text-[13px] text-[#E0E0E0] outline-none transition-colors duration-150 font-sans min-w-0 flex-1 focus:border-[#E8881A]" type="number" placeholder="12" min="1"
                                    ...
                                    <div className="flex-[1.4] flex items-center gap-1 px-2 border border-[#2A2A2A] rounded-lg bg-[#181818] focus-within:border-[#E8881A] transition-colors duration-150 py-2">
                                        <input className="bg-transparent border-none outline-none text-[#E0E0E0] text-[13px] w-full font-sans" type="number" placeholder="80" min="0" step="0.5"
                                ...
                                <div className="flex flex-col gap-2 sm:hidden">
                                    <div className="flex items-center gap-2">
                                        <input
                                            className="flex-1 bg-[#181818] border border-[#2A2A2A] rounded-lg py-2 px-2.5 text-[13px] text-[#E0E0E0] outline-none font-sans min-w-0 focus:border-[#E8881A]"
                                            type="text"
                                            placeholder={i === 0 ? "Supino reto com barra" : "Nome do exercício"}
                                            onChange={(e) => { const n = [...exercicios]; n[i].nome = e.target.value; setExercicios(n); }}
                                        />
                                    ...
                                    <div className="grid grid-cols-3 gap-2">
                                        <div>
                                            ...
                                            <input className="w-full bg-[#181818] border border-[#2A2A2A] rounded-lg py-2 px-2.5 text-[13px] text-[#E0E0E0] outline-none font-sans focus:border-[#E8881A]" type="number" placeholder="4" min="1"
                                                onChange={(e) => { const n = [...exercicios]; n[i].series = e.target.value; setExercicios(n); }} />
                                        </div>
                                        <div>
                                            <span className="block text-[10px] text-zinc-600 font-semibold uppercase mb-1">Reps</span>
                                            <input className="w-full bg-[#181818] border border-[#2A2A2A] rounded-lg py-2 px-2.5 text-[13px] text-[#E0E0E0] outline-none font-sans focus:border-[#E8881A]" type="number" placeholder="12" min="1"
                                                onChange={(e) => { const n = [...exercicios]; n[i].repeticoes = e.target.value; setExercicios(n); }} />
                                        </div>
                                        <div>
